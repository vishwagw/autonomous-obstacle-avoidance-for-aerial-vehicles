# first model we did build and there is a bug in this program:
# testing algorithm for test videos:
#for real time use, please use the live_detector.py algorithm
...
def obstacle_detection(video_path):
    ...
    while True:
        ...
        #frame = cv2.resize(frame, (640, 480))  # Resize frame to original dimensions
        ...
        cv2.putText(vis_frame, f"Frame: {frame_number}/{total_frames}", (width - 200, height - 20), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
